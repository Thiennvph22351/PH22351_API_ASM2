...
public class FragmentMain extends Fragment {
    ...
    private LinearLayout btnShounen, btnIsekai, btnSchool, btnLove;
    @Override
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        this.btnShounen = view.findViewById(R.id.category_Shounen);
        this.btnIsekai = view.findViewById(R.id.category_Isekai);
        this.btnSchool = view.findViewById(R.id.category_School);
        this.btnLove = view.findViewById(R.id.category_Love);
        ...
        btnShounen.setOnClickListener(new View.OnClickListener() {
            @Override
